...
Hetzner VPS 上で動いている自動売買パイプラインの状態を、Cloudflare KV 経由で集約し、Astro SSR で表示する公開ページを作りました。[Demo](https://ykts.net/trading-system/) として公開しています。
...
[Demo](https://ykts.net/trading-system/) は、内部で動いている自動売買パイプラインの一部を、公開可能な粒度へ整えて、ポートフォリオとして伝わる形にしたページです。
